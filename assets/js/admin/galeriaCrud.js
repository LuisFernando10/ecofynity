...
$('.btn-save').on('click', function () {
    ...
    let element_name = $('.js-galeria-nombre');
    let element_image = $('.js-galeria-image');
    ...
    form_data.append('galeria_name', value_name);

    form_data.append('action', 'INSERT');
    form_data.append('galeria_file', value_image);
...
$('.btn-edit').on('click', function () {
    ...
    //Obtenemos los elementos
    let element_frm_parent = $('.js-galeria-frm-edit');
    let element_name = element_frm_parent.find('.js-galeria-nombre');
    let element_image = $('.js-galeria-image');
    ...
    //Adicionamos las llaves y los valores que conformarán el FormData
    form_data.append('galeria_id', $(this).attr('data-id'));
    form_data.append('galeria_name', value_name);
...
$('.js-galeria-btn-delete').on('click', function () {
    //Nos os elementos do DOM
    let element_tr_parent = $(this).parents('tr.js-galerias-tr');

    //Nós obtemos o Id do galeria pra deletar
    let id_galeria = $(this).attr('data-id');
